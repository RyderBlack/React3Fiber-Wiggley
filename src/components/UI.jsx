...
export const UI = () => {
  ...
  return (
    <main className=" pointer-events-none fixed z-10 inset-0 pl-4 pt-0 flex justify-between flex-col">
      <a
        className="pointer-events-auto"
        href="https://github.com/RyderBlack"
      >
        <img className="w-60" src="/images/ryhverse_logo.png" />
      </a>
